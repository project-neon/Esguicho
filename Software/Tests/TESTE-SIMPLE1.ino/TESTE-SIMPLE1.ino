/* 
 * Código para testar uma estratégia simples, considerando o controle do juiz
 */
...
int start = 0;
const int I1 = 16; //Vou considerar o 16 o botão de iniciar o robô
const int I2 = 2064; //Vou considerar o 2064 o botão de parar o robô
...
void loop() {
  ...
  if (irrecv.decode(&results)) {
    switch(results.value) {
      case I1:
        if (start == 0) start = 1; //Adicionei um condicional pro robor morrer de vez e n voltar a se mexer caso alguém aperte I1 de novo.
        break;
      case I2:
        start = 2;
        break;
