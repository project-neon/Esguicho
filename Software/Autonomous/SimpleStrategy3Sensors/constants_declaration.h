...
const int distAtk = 500;
const int distAtkMax = 200;

const int speedMax = 85; //vel max para ser usada durande o ataque
const int speedStandard = 30; //vel padrão --- Cuidado se abaixar para menos de 
const int speedAtk = 70; //vel padrão --- Cuidado se abaixar para menos de 30!!!

const int searchSpeed = speedStandard*0.3;//vel de girar no proprio eixo
