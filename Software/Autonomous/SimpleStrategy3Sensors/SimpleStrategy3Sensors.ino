...
//////////////////////////////Estrategia//////////////////////////////
    ...
    distanceRead();
    if(distL < distAtk/4 and distR < distAtk/4) {
      Serial.print("ATACANDO MAX \t\t");
      speedL = speedR = speedAtk;
    } else if(distL < distAtk and distR < distAtk) {
      ...
      speedL = (distL < distAtk) ? searchSpeed : speedStandard;
      speedR = (distL < distAtk) ? speedStandard : searchSpeed;
