...
void motorsInit() {
    ...
    ESCL.attach(MOTOR_LEFT_PIN, 1000,2000);     // (Pino onde será enviado o sinal, largura de pulso mínima, largura de pulso máxima)
    ESCR.setPeriodHertz(50);
    ESCR.attach(MOTOR_RIGHT_PIN, 1000,2000);
    /*
